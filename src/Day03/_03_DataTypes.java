...
public class _03_DataTypes {
    public static void main(String[] args) {
        ...
        int intDeger = 250000;
        long longDeger = 232323232432414L;

        //ondalık sayılar
        //ondalıklı sayılarda default DOUBLE dır
        double doubleDeger = 3.1324141353153432;  //noktadan sonra 16 haneye duyarlıdır.
        float floatDeger = 4.2353243F;  // noktadan sonra 7 haneye duyarlıdır.
