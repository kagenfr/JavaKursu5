...
public class _02_JavaArithmeticOperators {
    public static void main(String[] args) {
        ...
        sayac++;  //sayacın değerini 1 artırır: 2
        ++sayac;  //sayacın değerini 1 artırır: 3
        ...
        //toplam=toplam+sayac;   sayac=sayac+1   toplam=toplam+ sayac++
        //--------------------------
        //sayac=sayac+1    toplam=toplam+sayac;  toplam=toplam+ ++sayac;
        //-------------------------
        //sayac++;   sayac--;
        //
    }
