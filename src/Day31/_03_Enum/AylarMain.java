...
public class AylarMain {
    ...
    public static void main(String[] args) {
        ...
        // ayın türkçe yazılışı için metod gerekiyor
        // ayın gerçek sıra nosu için metod gerekiyor

        // Java diyorki bu şekilde tek bir kelime veya
        // sayı olan degerleri olacaksa, sana bir kolaylık sağlayabilirim
